...
| Figure 3.1 | Accuracy as a function of labeled images per class. The steepest gain occurs between 25 and 100 images per class. | Ch. 3 |
...
| Table 3.2 | Class scaling results: accuracy, forgetting, and training time when adding one class to a 5-class and a 30-class base model. | Ch. 3 |
...
| Table 3.5 | Burn CUDA backend inference results comparing the baseline, SSL, and SSL optimized model versions. | Ch. 3 |
| Table 3.6 | Hardware benchmark comparison across four deployment targets for the SSL optimized model. | Ch. 3 |
