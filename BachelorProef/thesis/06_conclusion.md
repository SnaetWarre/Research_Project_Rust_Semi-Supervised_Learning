...
The reflection in Chapter 4 also points out the main limitations. The system has not yet been validated on real agricultural images from the field. Pseudo-label quality is still limited by the quality of the first model. The Burn ecosystem is less mature than PyTorch, and the project did not receive external expert feedback before the deadline, which means the reflection and advice rely on my own analysis rather than on independent industry validation.
