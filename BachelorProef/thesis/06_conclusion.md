...
The reflection in Chapter 4 also points out the main limitations. The system has not yet been validated on real agricultural images from the field. Pseudo-label quality is still limited by the quality of the first model. The Burn ecosystem is less mature than PyTorch. External expert validation is also not fully complete yet: Pedro Morais answered part of the expert questionnaire, while Helena Torres's response is still pending.
